...
public class TDbSync_Dsp_Campaign_Brand_Safe_Domain implements org.apache.thrift.TBase<TDbSync_Dsp_Campaign_Brand_Safe_Domain, TDbSync_Dsp_Campaign_Brand_Safe_Domain._Fields>, java.io.Serializable, Cloneable, Comparable<TDbSync_Dsp_Campaign_Brand_Safe_Domain> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDbSync_Dsp_Campaign_Brand_Safe_Domain");
  ...
  static {
    schemes.put(StandardScheme.class, new TDbSync_Dsp_Campaign_Brand_Safe_DomainStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDbSync_Dsp_Campaign_Brand_Safe_DomainTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDbSync_Dsp_Campaign_Brand_Safe_Domain.class, metaDataMap);
  }

  public TDbSync_Dsp_Campaign_Brand_Safe_Domain() {
  }
   ...
   */
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain(TDbSync_Dsp_Campaign_Brand_Safe_Domain other) {
  ...
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain deepCopy() {
    return new TDbSync_Dsp_Campaign_Brand_Safe_Domain(this);
  }
  ...
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain setCampaignID(int campaignID) {
    this.campaignID = campaignID;
    setCampaignIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain setDomain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain setStatus(int Status) {
    this.Status = Status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TDbSync_Dsp_Campaign_Brand_Safe_Domain setLastChanged(String lastChanged) {
    this.lastChanged = lastChanged;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDbSync_Dsp_Campaign_Brand_Safe_Domain)
      return this.equals((TDbSync_Dsp_Campaign_Brand_Safe_Domain)that);
    return false;
  }

  public boolean equals(TDbSync_Dsp_Campaign_Brand_Safe_Domain that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TDbSync_Dsp_Campaign_Brand_Safe_Domain other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDbSync_Dsp_Campaign_Brand_Safe_Domain(");
    boolean first = true;
  ...
  private static class TDbSync_Dsp_Campaign_Brand_Safe_DomainStandardSchemeFactory implements SchemeFactory {
    public TDbSync_Dsp_Campaign_Brand_Safe_DomainStandardScheme getScheme() {
      return new TDbSync_Dsp_Campaign_Brand_Safe_DomainStandardScheme();
    }
  }

  private static class TDbSync_Dsp_Campaign_Brand_Safe_DomainStandardScheme extends StandardScheme<TDbSync_Dsp_Campaign_Brand_Safe_Domain> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDbSync_Dsp_Campaign_Brand_Safe_Domain struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDbSync_Dsp_Campaign_Brand_Safe_Domain struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDbSync_Dsp_Campaign_Brand_Safe_DomainTupleSchemeFactory implements SchemeFactory {
    public TDbSync_Dsp_Campaign_Brand_Safe_DomainTupleScheme getScheme() {
      return new TDbSync_Dsp_Campaign_Brand_Safe_DomainTupleScheme();
    }
  }

  private static class TDbSync_Dsp_Campaign_Brand_Safe_DomainTupleScheme extends TupleScheme<TDbSync_Dsp_Campaign_Brand_Safe_Domain> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDbSync_Dsp_Campaign_Brand_Safe_Domain struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDbSync_Dsp_Campaign_Brand_Safe_Domain struct) throws org.apache.thrift.TException {
