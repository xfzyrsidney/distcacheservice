...
public class TDbSync_Dsp_Strategy_Creative_Sequence implements org.apache.thrift.TBase<TDbSync_Dsp_Strategy_Creative_Sequence, TDbSync_Dsp_Strategy_Creative_Sequence._Fields>, java.io.Serializable, Cloneable, Comparable<TDbSync_Dsp_Strategy_Creative_Sequence> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDbSync_Dsp_Strategy_Creative_Sequence");
  ...
  private static final org.apache.thrift.protocol.TField SEQUENCES_FIELD_DESC = new org.apache.thrift.protocol.TField("sequences", org.apache.thrift.protocol.TType.I32, (short)2);
  private static final org.apache.thrift.protocol.TField CREATIVE_CONCEPT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("creativeConceptID", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  static {
    schemes.put(StandardScheme.class, new TDbSync_Dsp_Strategy_Creative_SequenceStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDbSync_Dsp_Strategy_Creative_SequenceTupleSchemeFactory());
  }

  public int strategyID; // required
  public int sequences; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SEQUENCES((short)2, "sequences"),
    CREATIVE_CONCEPT_ID((short)3, "creativeConceptID"),
  ...
  private static final int __SEQUENCES_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.SEQUENCES, new org.apache.thrift.meta_data.FieldMetaData("sequences", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDbSync_Dsp_Strategy_Creative_Sequence.class, metaDataMap);
  }

  public TDbSync_Dsp_Strategy_Creative_Sequence() {
  }
   ...
   */
  public TDbSync_Dsp_Strategy_Creative_Sequence(TDbSync_Dsp_Strategy_Creative_Sequence other) {
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence deepCopy() {
    return new TDbSync_Dsp_Strategy_Creative_Sequence(this);
  }
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence setStrategyID(int strategyID) {
    this.strategyID = strategyID;
    setStrategyIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence setSequences(int sequences) {
    this.sequences = sequences;
    setSequencesIsSet(true);
    return this;
  }
  ...
  public void unsetSequences() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SEQUENCES_ISSET_ID);
  }

  /** Returns true if field sequences is set (has been assigned a value) and false otherwise */
  public boolean isSetSequences() {
    return EncodingUtils.testBit(__isset_bitfield, __SEQUENCES_ISSET_ID);
  }

  public void setSequencesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SEQUENCES_ISSET_ID, value);
  }
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence setCreativeConceptID(int creativeConceptID) {
    this.creativeConceptID = creativeConceptID;
    setCreativeConceptIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence setStatus(int Status) {
    this.Status = Status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TDbSync_Dsp_Strategy_Creative_Sequence setLastChanged(String lastChanged) {
    this.lastChanged = lastChanged;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SEQUENCES:
      return Integer.valueOf(getSequences());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDbSync_Dsp_Strategy_Creative_Sequence)
      return this.equals((TDbSync_Dsp_Strategy_Creative_Sequence)that);
    return false;
  }

  public boolean equals(TDbSync_Dsp_Strategy_Creative_Sequence that) {
    if (that == null)
      return false;
    ...
    boolean this_present_sequences = true;
    boolean that_present_sequences = true;
    if (this_present_sequences || that_present_sequences) {
      if (!(this_present_sequences && that_present_sequences))
        return false;
      if (this.sequences != that.sequences)
        return false;
    }
  ...
  @Override
  public int compareTo(TDbSync_Dsp_Strategy_Creative_Sequence other) {
    ...
    lastComparison = Boolean.valueOf(isSetSequences()).compareTo(other.isSetSequences());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSequences()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sequences, other.sequences);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDbSync_Dsp_Strategy_Creative_Sequence(");
    boolean first = true;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'sequences' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TDbSync_Dsp_Strategy_Creative_SequenceStandardSchemeFactory implements SchemeFactory {
    public TDbSync_Dsp_Strategy_Creative_SequenceStandardScheme getScheme() {
      return new TDbSync_Dsp_Strategy_Creative_SequenceStandardScheme();
    }
  }

  private static class TDbSync_Dsp_Strategy_Creative_SequenceStandardScheme extends StandardScheme<TDbSync_Dsp_Strategy_Creative_Sequence> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDbSync_Dsp_Strategy_Creative_Sequence struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SEQUENCES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.sequences = iprot.readI32();
              struct.setSequencesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetSequences()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'sequences' was not found in serialized data! Struct: " + toString());
      }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDbSync_Dsp_Strategy_Creative_Sequence struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(SEQUENCES_FIELD_DESC);
      oprot.writeI32(struct.sequences);
      oprot.writeFieldEnd();
  ...
  private static class TDbSync_Dsp_Strategy_Creative_SequenceTupleSchemeFactory implements SchemeFactory {
    public TDbSync_Dsp_Strategy_Creative_SequenceTupleScheme getScheme() {
      return new TDbSync_Dsp_Strategy_Creative_SequenceTupleScheme();
    }
  }

  private static class TDbSync_Dsp_Strategy_Creative_SequenceTupleScheme extends TupleScheme<TDbSync_Dsp_Strategy_Creative_Sequence> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDbSync_Dsp_Strategy_Creative_Sequence struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDbSync_Dsp_Strategy_Creative_Sequence struct) throws org.apache.thrift.TException {
