...
public class TDbSync_AdManager_Search_Engine implements org.apache.thrift.TBase<TDbSync_AdManager_Search_Engine, TDbSync_AdManager_Search_Engine._Fields>, java.io.Serializable, Cloneable, Comparable<TDbSync_AdManager_Search_Engine> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDbSync_AdManager_Search_Engine");
  ...
  static {
    schemes.put(StandardScheme.class, new TDbSync_AdManager_Search_EngineStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDbSync_AdManager_Search_EngineTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDbSync_AdManager_Search_Engine.class, metaDataMap);
  }

  public TDbSync_AdManager_Search_Engine() {
  }
   ...
   */
  public TDbSync_AdManager_Search_Engine(TDbSync_AdManager_Search_Engine other) {
  ...
  public TDbSync_AdManager_Search_Engine deepCopy() {
    return new TDbSync_AdManager_Search_Engine(this);
  }
  ...
  public TDbSync_AdManager_Search_Engine setID(int iD) {
    this.iD = iD;
    setIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Search_Engine setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Search_Engine setLastChanged(String lastChanged) {
    this.lastChanged = lastChanged;
    return this;
  }
  ...
  public TDbSync_AdManager_Search_Engine setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TDbSync_AdManager_Search_Engine setDomain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TDbSync_AdManager_Search_Engine setKeyword(String keyword) {
    this.keyword = keyword;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDbSync_AdManager_Search_Engine)
      return this.equals((TDbSync_AdManager_Search_Engine)that);
    return false;
  }

  public boolean equals(TDbSync_AdManager_Search_Engine that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TDbSync_AdManager_Search_Engine other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDbSync_AdManager_Search_Engine(");
    boolean first = true;
  ...
  private static class TDbSync_AdManager_Search_EngineStandardSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Search_EngineStandardScheme getScheme() {
      return new TDbSync_AdManager_Search_EngineStandardScheme();
    }
  }

  private static class TDbSync_AdManager_Search_EngineStandardScheme extends StandardScheme<TDbSync_AdManager_Search_Engine> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDbSync_AdManager_Search_Engine struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDbSync_AdManager_Search_Engine struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDbSync_AdManager_Search_EngineTupleSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Search_EngineTupleScheme getScheme() {
      return new TDbSync_AdManager_Search_EngineTupleScheme();
    }
  }

  private static class TDbSync_AdManager_Search_EngineTupleScheme extends TupleScheme<TDbSync_AdManager_Search_Engine> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Search_Engine struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Search_Engine struct) throws org.apache.thrift.TException {
