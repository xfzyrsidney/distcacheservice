...
public class TDbSync_AdManager_Creative_Concept_Target implements org.apache.thrift.TBase<TDbSync_AdManager_Creative_Concept_Target, TDbSync_AdManager_Creative_Concept_Target._Fields>, java.io.Serializable, Cloneable, Comparable<TDbSync_AdManager_Creative_Concept_Target> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDbSync_AdManager_Creative_Concept_Target");
  ...
  private static final org.apache.thrift.protocol.TField TARGET_AUDIENCE_RULES_FIELD_DESC = new org.apache.thrift.protocol.TField("targetAudienceRules", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  static {
    schemes.put(StandardScheme.class, new TDbSync_AdManager_Creative_Concept_TargetStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDbSync_AdManager_Creative_Concept_TargetTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TARGET_AUDIENCE_RULES((short)3, "targetAudienceRules"),
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDbSync_AdManager_Creative_Concept_Target.class, metaDataMap);
  }

  public TDbSync_AdManager_Creative_Concept_Target() {
  }
   ...
   */
  public TDbSync_AdManager_Creative_Concept_Target(TDbSync_AdManager_Creative_Concept_Target other) {
  ...
  public TDbSync_AdManager_Creative_Concept_Target deepCopy() {
    return new TDbSync_AdManager_Creative_Concept_Target(this);
  }
  ...
  public TDbSync_AdManager_Creative_Concept_Target setMediaBuyID(int mediaBuyID) {
    this.mediaBuyID = mediaBuyID;
    setMediaBuyIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Creative_Concept_Target setCreativeID(int creativeID) {
    this.creativeID = creativeID;
    setCreativeIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Creative_Concept_Target setTargetAudienceRules(String targetAudienceRules) {
    this.targetAudienceRules = targetAudienceRules;
    return this;
  }
  ...
  public TDbSync_AdManager_Creative_Concept_Target setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Creative_Concept_Target setLastChanged(String lastChanged) {
    this.lastChanged = lastChanged;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDbSync_AdManager_Creative_Concept_Target)
      return this.equals((TDbSync_AdManager_Creative_Concept_Target)that);
    return false;
  }

  public boolean equals(TDbSync_AdManager_Creative_Concept_Target that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TDbSync_AdManager_Creative_Concept_Target other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDbSync_AdManager_Creative_Concept_Target(");
    boolean first = true;
  ...
  private static class TDbSync_AdManager_Creative_Concept_TargetStandardSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Creative_Concept_TargetStandardScheme getScheme() {
      return new TDbSync_AdManager_Creative_Concept_TargetStandardScheme();
    }
  }

  private static class TDbSync_AdManager_Creative_Concept_TargetStandardScheme extends StandardScheme<TDbSync_AdManager_Creative_Concept_Target> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDbSync_AdManager_Creative_Concept_Target struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDbSync_AdManager_Creative_Concept_Target struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDbSync_AdManager_Creative_Concept_TargetTupleSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Creative_Concept_TargetTupleScheme getScheme() {
      return new TDbSync_AdManager_Creative_Concept_TargetTupleScheme();
    }
  }

  private static class TDbSync_AdManager_Creative_Concept_TargetTupleScheme extends TupleScheme<TDbSync_AdManager_Creative_Concept_Target> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Creative_Concept_Target struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Creative_Concept_Target struct) throws org.apache.thrift.TException {
