...
public class TDbSync_AdManager_Media_Buy_Dayparting implements org.apache.thrift.TBase<TDbSync_AdManager_Media_Buy_Dayparting, TDbSync_AdManager_Media_Buy_Dayparting._Fields>, java.io.Serializable, Cloneable, Comparable<TDbSync_AdManager_Media_Buy_Dayparting> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDbSync_AdManager_Media_Buy_Dayparting");
  ...
  static {
    schemes.put(StandardScheme.class, new TDbSync_AdManager_Media_Buy_DaypartingStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TDbSync_AdManager_Media_Buy_DaypartingTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDbSync_AdManager_Media_Buy_Dayparting.class, metaDataMap);
  }

  public TDbSync_AdManager_Media_Buy_Dayparting() {
  }
   ...
   */
  public TDbSync_AdManager_Media_Buy_Dayparting(TDbSync_AdManager_Media_Buy_Dayparting other) {
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting deepCopy() {
    return new TDbSync_AdManager_Media_Buy_Dayparting(this);
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setMediaBuyID(int mediaBuyID) {
    this.mediaBuyID = mediaBuyID;
    setMediaBuyIDIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setLastChanged(String lastChanged) {
    this.lastChanged = lastChanged;
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setMonday(int monday) {
    this.monday = monday;
    setMondayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setTuesday(int tuesday) {
    this.tuesday = tuesday;
    setTuesdayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setWednesday(int wednesday) {
    this.wednesday = wednesday;
    setWednesdayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setThursday(int thursday) {
    this.thursday = thursday;
    setThursdayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setFriday(int friday) {
    this.friday = friday;
    setFridayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setSaturday(int saturday) {
    this.saturday = saturday;
    setSaturdayIsSet(true);
    return this;
  }
  ...
  public TDbSync_AdManager_Media_Buy_Dayparting setSunday(int sunday) {
    this.sunday = sunday;
    setSundayIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TDbSync_AdManager_Media_Buy_Dayparting)
      return this.equals((TDbSync_AdManager_Media_Buy_Dayparting)that);
    return false;
  }

  public boolean equals(TDbSync_AdManager_Media_Buy_Dayparting that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TDbSync_AdManager_Media_Buy_Dayparting other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDbSync_AdManager_Media_Buy_Dayparting(");
    boolean first = true;
  ...
  private static class TDbSync_AdManager_Media_Buy_DaypartingStandardSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Media_Buy_DaypartingStandardScheme getScheme() {
      return new TDbSync_AdManager_Media_Buy_DaypartingStandardScheme();
    }
  }

  private static class TDbSync_AdManager_Media_Buy_DaypartingStandardScheme extends StandardScheme<TDbSync_AdManager_Media_Buy_Dayparting> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDbSync_AdManager_Media_Buy_Dayparting struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDbSync_AdManager_Media_Buy_Dayparting struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TDbSync_AdManager_Media_Buy_DaypartingTupleSchemeFactory implements SchemeFactory {
    public TDbSync_AdManager_Media_Buy_DaypartingTupleScheme getScheme() {
      return new TDbSync_AdManager_Media_Buy_DaypartingTupleScheme();
    }
  }

  private static class TDbSync_AdManager_Media_Buy_DaypartingTupleScheme extends TupleScheme<TDbSync_AdManager_Media_Buy_Dayparting> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Media_Buy_Dayparting struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDbSync_AdManager_Media_Buy_Dayparting struct) throws org.apache.thrift.TException {
